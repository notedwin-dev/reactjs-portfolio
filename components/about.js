    ...
    <section id="about" className="min-h-screen px-10">
      ...
      <div className="text-center p-8">
        ...
        <h3 className="font-sans text-2xl py-2 text-black dark:text-white">
          Freelance Full Stack Developer and University Student.
        </h3>
        <p className="font-sans leading-8 text-gray-600 dark:text-gray-300">
          Hello there, My name is Edwin! I am a{" "}
          {new Date().getFullYear() - 2004} years old freelance developer who
          likes to explore and experiment around with Discord-related libraries
          and projects!<br></br>

    ...
    return (
        <section className="min-h-screen px-10">
            ...
            <div className="text-center p-10">
                ...
                <h3 className="font-sans text-2xl py-2 text-black dark:text-white">大学生 兼 全栈工程师。</h3>
                <p className="font-sans leading-8 text-gray-600 dark:text-gray-300">目前正在开发多个开源的GitHub模板。比如：discord-ws 和 autocode-discord.js。</p>
            </div>

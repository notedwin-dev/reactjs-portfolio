        ...
        <section className="h-auto px-10">
          <div className="text-center">
            ...
            <p className="font-sans text-md leading-8 text-gray-600 dark:text-gray-300">
              ...
              以及
              <span className="text-blue--100 dark:text-cyan-500">工具</span>。
            </p>
          </div>
          ...
          <div className="lg:flex gap-8">
            <div className={cards}>
              ...
              <h2 className="font-bold text-blue-400 dark:text-green-600">
                Node.js
              </h2>
              <p>
                Node.js 是一个开源、跨平台的后端 JavaScript
                运行环境。Node.js可透过JavaScript和一系列模块来编写服务器端应用和网络相关的应用。
              </p>
              <h2 className="font-semibold text-cyan-500 my-2 dark:text-cyan-600">
                使用工具
              </h2>
              <div className={tag}>
                <BiCodeBlock className="mr-1" /> Autocode
              </div>
              <div className={tag}>
              ...
              <div className={tag}>
                <SiReplit className="mr-1" /> Replit
              </div>
              <div className={tag}>
              ...
              <div className={tag}>
                <SiDiscord className="mr-1" /> Discord.js
              </div>
              <div className={tag}>
              ...
              <div className={tag}>
                <SiJavascript className="mr-1" /> jimp
              </div>
              <div className={tag}>
                <SiJavascript className="mr-1" /> lib
              </div>
              <div className={tag}>
                <SiJavascript className="mr-1" /> node-fetch
              </div>
              <div className={tag}>
                <SiJavascript className="mr-1" /> canvas
              </div>
              <div className={tag}>
                <SiJavascript className="mr-1" /> ws
              </div>
              <div className={tag}>
            ...
            <div className={cards}>
              ...
              <h2 className="font-bold text-blue-400 dark:text-blue-700">
                编程语言
              </h2>
              <p>
                编程语言是一种能够让程序员准确地定义计算机所需要使用数据的计算机语言，并精确地定义在不同情况下所应当采取的行动。
              </p>
              <h2 className="font-semibold text-cyan-500 my-2 dark:text-cyan-600">
                使用工具
              </h2>
              ...
              <div className={tag}>
                <SiIntellijidea className="mr-1" /> IntelliJ
              </div>
              <div className={tag}>
            ...
            <div className={cards}>
              ...
              <h2 className="font-bold text-blue-400 dark:text-yellow-600">
                网页开发
              </h2>
              <p>
                网页开发指的是网站的创建、构建和维护。
                它包括网页设计、网页发布、网页编程和数据库管理等方面。
              </p>
              <h2 className="font-semibold text-cyan-500 my-2 dark:text-cyan-600">
                Tools
              </h2>
              ...
              <div className={tag}>
                <IoLogoJavascript className="mr-1" /> JavaScript
              </div>
              <div className={tag}>

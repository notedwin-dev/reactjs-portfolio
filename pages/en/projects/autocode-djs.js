      ...
      <main className="bg-white dark:bg-slate-800">
        <section className="px-10">
          ...
          <div className="text-center mx-10">
            ...
            <Link href="https://github.com/Edwin15857/autocode-discordjs">
              <h1 className="font-bold text-2xl text-slate-500 pb-5 dark:text-blue-gray-100">
                Autocode-Discord.js Github Repository
              </h1>
            </Link>
          </div>
          ...
          <div className="flex justify-center my-8">
            <iframe
              src="https://github.com/Edwin15857/autocode-discordjs"
              width={1240}
              height={720}
              name="Autocode discord.js Github Repository"
            />
          </div>
        </section>
        <Footer />

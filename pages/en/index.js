        ...
        <section className="h-auto px-10">
          <div className="text-center">
            ...
            <p className="font-sans text-md leading-8 text-gray-600 dark:text-gray-300">
              ...
              and{" "}
              <span className="text-blue--100 dark:text-cyan-500">Tools</span>{" "}
          ...
          <div className="grid gap-10 mb-10 md:grid-cols-2 sm:grid-cols-1 lg:grid-cols-3">
            <div className={cards}>
              ...
              <h2 className="font-semibold text-cyan-500 my-2 dark:text-cyan-600">
                JavaScript Modules I&apos;m good at
              </h2>
              <div className={tag}>
            ...
            <div className={cards}>
              ...
              <p>
                Web development is the work involved in designing, developing
                and deploying a website for hosting on the Internet.
              </p>
              <h2 className="font-semibold text-cyan-500 my-2 dark:text-cyan-600">
